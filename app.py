...
app.layout = html.Div([
    ...
    html.H6("Instructions: Search for a board game in Step 1 and enter that ID into Step 2 along with the number of players you have.", style={'text-align':'center'}),
